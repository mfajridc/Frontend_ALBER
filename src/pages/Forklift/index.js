...
export default class Forklift extends Component  {
    ...
    constructor(props) {
        super(props);
        this.state = {
            dataPekerjaan: ['Loading/Unloading', 'Housekeeping', 'Kepentingan Pabrik'],
            nomorPalka: ['1', '2', '3', '4'],
    ...
    send = async () => {
        try {
            await fetch('http://10.14.16.162/backend/forklift.php', {
                method: 'POST',
                headers: {
    ...
    render() {
        const { no_order, pekerjaan, kapal, no_palka, kegiatan, area } = this.state.formData;
            ...
            <ScrollView
                ...
                <View style={style.wrapper}>
                    ...
                    <View style={style.InputContainer}>
                        <TextInput placeholder="No order"
                    ...
                    <View style={style.InputContainer}>
                        <TextInput placeholder="Nama Kapal"
                            onChangeText={kapal =>
                                this.setState(prevState => ({
                                    formData: {
                                        ...prevState.formData,
                    ...
                    <View style={style.InputContainerr}>
                        <TextInput placeholder="Deskripsi Kegiatan"
...
const style = StyleSheet.create({
    ...
    pickerteks: {
        ...
        fontSize: -16, color: '#858585', alignItems: "center",
        marginLeft: -24,
        marginRight: -20,
        padding: 28,
        height: 46, marginTop: -6
    }
